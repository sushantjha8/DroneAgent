...
"""Vehicle provides access to vehicle state through python attributes (e.g. Vehicle.mode) and to settings/parameters though the Vehicle.parameters attribute. 
